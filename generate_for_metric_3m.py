...
if __name__ == "__main__":
    gts_json = generate_gts()
    res_json = generate_res()
    # only gts
    print(list(set(gts_json.keys()) - set(res_json.keys())))
    # only res
    print(list(set(res_json.keys()) - set(gts_json.keys())))
    assert gts_json.keys() == res_json.keys()